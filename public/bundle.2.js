...
"use strict";
/* unused harmony export setPostsSuccess */
/* harmony export (immutable) */ __webpack_exports__["b"] = fetchPostsByPageIndex;
/* harmony export (immutable) */ __webpack_exports__["a"] = fetchPostById;
...
function setPostsSuccess(posts) {
    return {
        type: __WEBPACK_IMPORTED_MODULE_1__types__["b" /* SET_POSTS */],
        payload: posts
    };
}

function fetchPostsByPageIndex(index) {
    return function (dispatch) {
        return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/page/get-posts-by-page-index', { index: index }).then(function (res) {
            if (Array.isArray(res.data) && res.data.length > 0) {
                dispatch(setPostsSuccess(_defineProperty({}, index, res.data)));
                return res.data;
            }
            return null;
        }).catch(function () {
...
function fetchPostById(id) {
    return function () {
        return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/page/get-post-by-id', { id: id }).then(function (res) {
            return res.data;
        }).catch(function () {
            return null;
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_styled_components__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_animations_lib_fade_in__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_animations_lib_fade_in___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_animations_lib_fade_in__);
...
var animationFadeIn = Object(__WEBPACK_IMPORTED_MODULE_0_styled_components__["b" /* keyframes */])(_templateObject, __WEBPACK_IMPORTED_MODULE_1_react_animations_lib_fade_in___default.a);

var FadeIn = __WEBPACK_IMPORTED_MODULE_0_styled_components__["a" /* default */].div(_templateObject2, animationFadeIn);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stylis_rule_sheet__ = __webpack_require__(193);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = toLocaleString;
